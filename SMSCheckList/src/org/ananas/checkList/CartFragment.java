...
public class CartFragment extends Fragment
{
    ...
    public CartFragment(ArrayList<ListItemData> listItemData, ArrayList<ListItemData> cartItemData) {
        _lid = listItemData;
        _cid = cartItemData;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // находим список
        ListView lvMain = (ListView) rootView.findViewById(R.id.cartListView);
    ...
    public void setList(Context context, ListView lv, ArrayList<ListItemData> lid, ArrayList<ListItemData> cid) {
        if (lv != null) {
            ...
            // создаем адаптер
            ArrayAdapter<ListItemData> adapter = new CartListAdapter(context, R.layout.checked_list_item, R.id.item_text, lid, cid);
